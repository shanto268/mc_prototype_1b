...
#include <iostream>
{
    ...
    TFile *f1 = new TFile("output_withoutbox10m.root","READ"); //away
    TFile *f2 = new TFile("output_withbox10m.root","READ"); //towards

    TH1D* x7away=(TH1D*)f1->Get("xZ9");
    TH1D* x7tank=(TH1D*)f2->Get("xZ9");

    TH1D* y7away=(TH1D*)f1->Get("yZ9");
    TH1D* y7tank=(TH1D*)f2->Get("yZ9");

    TH2D* xy7away=(TH2D*)f1->Get("xyZ9");
    TH2D* xy7tank=(TH2D*)f2->Get("xyZ9");
    /*
    ...
    */
    ...
    TH2D* plotA=new TH2D("plotA","MC Lead Box",15,-15.0,15.0,15,-15.0,15.0);
