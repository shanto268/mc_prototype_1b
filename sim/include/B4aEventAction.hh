...
class B4aEventAction : public G4UserEventAction
{
  public:
    ...
    void AddHits1Tray(SC8Particle aSC8particle);
    void AddHits2Tray(SC8Particle aSC8particle);
    void AddSBAR(double step, double de, int indexTray, int indexSBAR); //changed by SAS 29/11
    void AddTestObj(double step, double de);
  ...
  private:
    ...
    std::vector<SC8Particle>  vecSC8Hits1Tray;
    std::vector<SC8Particle>  vecSC8Hits2Tray;
...
inline void B4aEventAction::AddHits1Tray(SC8Particle aSC8Particle) {
	//     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1..."<<std::endl;
	//     //       std::cout<<"   size="<<vecSC8HitsRef1.size()<<std::endl;
	//     //       std::cout<<"   aSC8Particle... "<<aSC8Particle.pid<<std::endl;
      vecSC8Hits1Tray.push_back(aSC8Particle);
	//           //     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1   end..."<<std::endl;
	//           }
}

inline void B4aEventAction::AddHits2Tray(SC8Particle aSC8Particle) {
	//     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1..."<<std::endl;
	//     //       std::cout<<"   size="<<vecSC8HitsRef1.size()<<std::endl;
	//     //       std::cout<<"   aSC8Particle... "<<aSC8Particle.pid<<std::endl;
      vecSC8Hits2Tray.push_back(aSC8Particle);
	//           //     std::cout<<"rpdebug- B4aEventAction::AddHitsRef1   end..."<<std::endl;
	//           }
}
...
inline void B4aEventAction::AddTestObj(double step, double de) { //SAS comment: pass on steplength as param
  // std::cout<<"inline void B4aEventAction::AddSBAR"<<std::endl;
  edepSc8.EdepTestObj += de;
  edepSc8.StepTestObj += step;
  // std::cout<<"inline void B4aEventAction::AddSBAR, end."<<std::endl;
}
