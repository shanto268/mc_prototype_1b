...
class MuonTree{
   public:
      ...
      void analyze(SC8edep edepSc8, std::vector<SC8Particle> part, 
	   ...
	   std::vector<SC8Particle> hitsTray1,
      std::vector<SC8Particle> hitsTray2,
...
//      float mLengthWall;
      ...
      int   mNHitsT1;
      float mHitsT1Vx[MAXGENPAR];
      float mHitsT1Vy[MAXGENPAR];
      float mHitsT1Vz[MAXGENPAR];

      int   mNHitsT2;
      float mHitsT2Vx[MAXGENPAR];
      float mHitsT2Vy[MAXGENPAR];
      float mHitsT2Vz[MAXGENPAR];
