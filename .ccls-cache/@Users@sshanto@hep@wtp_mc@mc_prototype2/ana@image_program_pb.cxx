...
#include <iostream>
{
    ...
    TH1D* x7away=(TH1D*)f1->Get("xZ7");
    TH1D* x7tank=(TH1D*)f2->Get("xZ7");

    TH1D* y7away=(TH1D*)f1->Get("yZ7");
    TH1D* y7tank=(TH1D*)f2->Get("yZ7");

    TH2D* xy7away=(TH2D*)f1->Get("xyZ7");
    TH2D* xy7tank=(TH2D*)f2->Get("xyZ7");
    /*
